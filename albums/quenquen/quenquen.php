    ...
    <div class="col-sm-9 col-md-8 col-lg-8">
      <div class="row-sm-6 row-md-6 row-lg-6">
          <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="thumbnail">
                <a href="/albums/viewphoto.php?q=quenquen/chanh-muoi-chua-benh.jpg"><img src="chanh-muoi-chua-benh.jpg" alt="..."></a>
                <div class="caption">
                  
                  <div class="postby"><p><span class="text-muted">Post by admin</span></p></div><div class="viewcount"> <p><span class="text-muted"><? echo (readView("chanh-muoi-chua-benh.view")); echo( " view"); ?> </span></p>
                  </div>
                  <div><br></div>
                </div>
              </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="thumbnail">
                <a href="/albums/viewphoto.php?q=quenquen/IMG_0008.jpg"><img src="IMG_0008.jpg" alt="..."></a>
                <div class="caption">
                  
                  <div class="postby"><p><span class="text-muted">Post by admin</span></p></div><div class="viewcount"> <p><span class="text-muted"><? echo (readView("IMG_0008.view")); echo( " view"); ?> </span></p>
                  </div>
                  <div><br></div>
                </div>
              </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="thumbnail">
                <a href="/albums/viewphoto.php?q=quenquen/IMG_0553.JPG""><img src="IMG_0553.jpg" alt="..."></a>
                <div class="caption">
                  
                  <div class="postby"><p><span class="text-muted">Post by admin</span></p></div><div class="viewcount"> <p><span class="text-muted"><? echo (readView("IMG_0553.view")); echo( " view"); ?> </span></p>
                  </div>
                  <div><br></div>
                </div>
              </div>
